...
<head>
    ...
    <style>
        ...
        .btn { text-decoration: none; padding: 10px; color: white; background-color: #007bff; border-radius: 5px; }
        ...
        .btn-default { background-color: #28a745; border: none; padding: 10px 20px; color: #fff; border-radius: 5px; cursor: pointer; }
    </style>
</head>
<body>
<div class="container">
